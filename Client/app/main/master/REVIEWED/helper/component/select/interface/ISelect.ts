...
export interface SelectGuruOptionData {
    id: string;
    text: string;
    disabled?: boolean;
    children?: Array<SelectGuruOptionData>;
    additional?: any;
}

export interface SelectGuruTemplateFunction {
    (state: SelectGuruOptionData): JQuery | string;
}
...
type AjaxFunction = (settings: JQueryAjaxSettings, success?: (data: any) => null, failure?: () => null) => JQueryXHR;
...
export interface SelectGuruOptions {
    amdBase?: string;
    ...
    tokenizer?: (input: string, selection: any[], selectCallback: () => void, options: SelectGuruOptions) => string;
...
export interface JQuery {
    ...
    */
    ...
    select2(options: SelectGuruOptions): JQuery;
}

declare class Select2 {
    constructor(element: JQuery, options: SelectGuruOptions);
    focus(): void;
    destroy(): void;
    ...
    $selection: JQuery;
    $results: JQuery;
    options: { options: SelectGuruOptions };
}
