...
var layout = function () {
    ...
    function createSubmenuHover() {
        ...
        $('.nav-sidebar .children .children-1').css('display', '');
        $('.nav-sidebar .children .children-1 .children-2').css('display', '');
    ...
    function removeSubmenuHover() {
        ...
        $('.nav-sidebar .nav-parent.active .children .children-1').css('display', 'block');
        $('.nav-sidebar .nav-parent.active .children .children-1 .children-2').css('display', 'block');
        $.removeCookie('submenu-hover');
    }
